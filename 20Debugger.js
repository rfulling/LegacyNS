      ...
      var tranSearch = search.create({
			type: transType
               ...
               ifFilters=search.createFilter({
      			...
      			ifColumns=search.createColumn({
      				name: 'amount',
      				summary: 'sum'
      				
      				});
          
      			log.debug( 'columns  ', ifColumns);
		   ...
		   invoiceRec = record.create({
                ...
                //});
				 invoiceRec.setValue({
                    fieldId: 'custbody_bsg_eqr_reservation_id',
                    value: 43
                });
				   invoiceRec.setValue({
                    fieldId: 'department',
                ...
                //    });
                        ...
                        invoiceRec.setCurrentSublistValue({ sublistId: 'item', fieldId: 'item', value: 43 });
